...
type Transaction struct {
	ID            string  `json:"tr_id"          dynamodbav:"tr_id"          validate:"required"`
	...
	Amount        float64 `json:"amount"         dynamodbav:"amount"         validate:"gt=0"`
}

// TransactionPK represents the primary key of a transaction item.
...
// SetDefaults converts Transaction to DynamoDB AttributeValue map
